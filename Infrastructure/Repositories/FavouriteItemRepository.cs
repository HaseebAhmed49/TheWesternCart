...
{
    public class FavouriteItemRepository : GenericRepository<FavouriteItem>, IFavouriteItemRepository
    {
        public FavouriteItemRepository(ApplicationDbContext context) : base(context)
        {
        }
        ...
        public async Task<FavouriteItem> GetByClothingItemIdAndUserId(Guid clothingItemId, string userId)
        {
            return await _context.FavoriteItems
                .Include(f => f.ClothingItem)
